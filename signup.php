...
<html lang="en">
  ...
  <body>
    ...
    <div class="registeration-box">
      ...
      $formData = isset($_SESSION['signup_form_data']) ? $_SESSION['signup_form_data'] : array();
      
      if(isset($_GET['error'])){
          if($_GET['error'] == 'emptyInput'){
              echo '<div class="alert alert-danger">All fields are required!</div>';
          }elseif($_GET['error'] == 'enterValidNumber'){
              ...
              echo '<div class="alert alert-danger">Password must be at least 6 characters long and contain both letters and numbers!</div>';
          }
      }
      ?>
    <hr>
      ...
      <?php
      // Clear session data after form is fully rendered
