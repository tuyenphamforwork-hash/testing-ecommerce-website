...
<body>
                ...
                <div class="appointments-section">
                    ...
                    <section class="edit-detail-field">
                        <form action="payment.php" method="post" class="Add-child-section">
                            <div class="child-detail-inner">
                              
                                <div class="child-fields child-fields1">
                                    <input type="text" name="first_name" style="color: #676767;" placeholder="First Name">
                                </div>
                                <div class="child-fields child-fields3">
                                    <input type="text" name="last_name" style="color: #676767;" placeholder="Last Name">
                                </div>
                            ...
                            <div class="child-detail-inner">
                                ...
                                <div class="child-fields child-fields4">
                                    <input type="text" name="house_number" placeholder="P-134">
                                </div>
                                <div class="child-fields child-fields5 ">
                                    <input type="text" name="street" placeholder="A5">
                                </div>
                            ...
                            <div class="child-detail-inner">
                                ...
                                <div class="child-fields child-fields6">
                                    <input type="text" name="town_city" placeholder="Manchester">
                                </div>
                                <div class="child-fields child-fields7 ">
                                    <input type="text" name="post_code" placeholder="38000">
                                </div>
                            ...
                            <div class="child-detail-inner">
                                ...
                                <div class="child-fields Address-field">
                                    <input type="text" name="country" style="color: #676767;" placeholder="United Kingdom">
                            ...
                            <div class="child-detail-inner">
                                ...
                                <div class="child-fields child-fields8">
                                    <input type="text" name="phone" placeholder="+1 0000-0000-0000">
                                </div>
                            ...
                            <div class="child-register-btn">
                                ...
                                <button type="submit" id="checkoutButton">Proceed To Pay</button>
                            </div>
                        </form>
            ...
            <script>
                function checkFields(){
                    const fields = document.querySelectorAll('.Add-child-section input');
                    const error = document.querySelector('.error-ms');

                    if(fields.length === 0){
                        error.innerHTML = "Validation error: no fields found.";
                        return false;
                    }
                ...
                document.addEventListener('DOMContentLoaded', function(){
                    const checkoutForm = document.querySelector('.Add-child-section');
                    if(checkoutForm){
