...
// if already logged in, redirect to profile instead of showing a blank page
...
<html lang="en">
  ...
  <body>
     ...
     ?>    <?php if (isset($_GET['login_required']) && $_GET['login_required'] == '1'): ?>
      <div class="alert alert-warning" role="alert" style="width: 400px; margin-bottom: 20px;">
        Please login to continue.
      </div>
    <?php endif; ?>    <form action="<?php echo $_SERVER['PHP_SELF']; ?> " method="post">
      <div class="logo-box">
        <img
      ...
      <div style="float: right">
        <a href="./signup.php" id="signup-btn" class="btn btn-secondary me-2">
          Sign up
        </a>
